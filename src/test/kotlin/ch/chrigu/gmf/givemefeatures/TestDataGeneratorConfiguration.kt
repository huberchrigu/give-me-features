        ...
        runBlocking {
            if (featureService.getFeatures().toList().isEmpty()) {
                ...
                featureService.newFeature(
                    Feature.describeNewFeature(
                        "Rich Text Feature",
                        Markdown("# A header\n## Another header\n### Yet another header\nA series of rich text content:\n - an itemized list\n - with several elements\n   - and indented\n\n1. a numbered list\n1. with several numbers\n\n> A quote\n> > A quote within a quote\n\n A **bold text**, an _italic text_, [a link](https://www.google.ch), a simple `inline code` and an image: ![an image](https://www.google.ch/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png)\n\n```javascript\nvar s = \"Hi There!\";\nalert(s)\n```\n\nA table:\n\n|First Column|Second Column|\n|-|-|\n|A1|A2|\n|B1|B2|")
                    )
                )
            }
        }
